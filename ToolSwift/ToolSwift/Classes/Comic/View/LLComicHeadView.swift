...
class LLComicHeadCCell: LLBaseCollectionViewCell {
...
class LLComicHeadView: UIView {
    ...
    private lazy var thmemView: UICollectionView = {
        ...
        tw.register(cellType: LLComicHeadCCell.self)
        return tw
    }()
...
extension LLComicHeadView: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(for: indexPath, cellType: LLComicHeadCCell.self)
