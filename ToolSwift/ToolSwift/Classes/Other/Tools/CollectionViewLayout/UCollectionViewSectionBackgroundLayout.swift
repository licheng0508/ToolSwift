...
private let SectionBackground = "LLCollectionReusableView"

protocol LLCollectionViewSectionBackgroundLayoutDelegateLayout: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView,
                        layout collectionViewLayout: UICollectionViewLayout,
                        backgroundColorForSectionAt section: Int) -> UIColor
}

extension LLCollectionViewSectionBackgroundLayoutDelegateLayout {
    func collectionView(_ collectionView: UICollectionView,
                        layout collectionViewLayout: UICollectionViewLayout,
                        backgroundColorForSectionAt section: Int) -> UIColor {
...
private class LLCollectionViewLayoutAttributes: UICollectionViewLayoutAttributes {
    var backgroundColor = UIColor.white
    
    override func copy(with zone: NSZone? = nil) -> Any {
        let copy = super.copy(with: zone) as! LLCollectionViewLayoutAttributes
        copy.backgroundColor = self.backgroundColor
        return copy
    }
    
    override func isEqual(_ object: Any?) -> Bool {
        guard let rhs = object as? LLCollectionViewLayoutAttributes else {
            return false
        }
...
private class UCollectionReusableView: UICollectionReusableView {
    ...
    override func apply(_ layoutAttributes: UICollectionViewLayoutAttributes) {
        ...
        guard let attr = layoutAttributes as? LLCollectionViewLayoutAttributes else {
            return
        }
...
class LLCollectionViewSectionBackgroundLayout: UICollectionViewFlowLayout {
    ...
    override func prepare() {
        ...
        guard let numberOfSections = self.collectionView?.numberOfSections,
            let delegate = self.collectionView?.delegate as? LLCollectionViewSectionBackgroundLayoutDelegateLayout
            else {
                return
        }
        ...
        for section in 0..<numberOfSections {
            ...
            let attr = LLCollectionViewLayoutAttributes(forDecorationViewOfKind: SectionBackground, with: IndexPath(item: 0, section: section))
