//
//  LLCollectionViewAlignedLayout.swift
//  ToolSwift
//
...
public class LLCollectionViewAlignedLayout: UICollectionViewFlowLayout {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: LLCollectionViewAlignedLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: LLCollectionViewAlignedLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: LLCollectionViewAlignedLayout) {
    ...
    private func alignToFollowingItem(collectionViewLayout: LLCollectionViewAlignedLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: LLCollectionViewAlignedLayout) {
    ...
    func alignVertically(collectionViewLayout: LLCollectionViewAlignedLayout) {
