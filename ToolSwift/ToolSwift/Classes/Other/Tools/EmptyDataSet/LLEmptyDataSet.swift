...
extension UIScrollView {
    ...
    var uempty: LLEmptyView? {
        get {
            return objc_getAssociatedObject(self, &AssociatedKeys.uemptyKey) as? LLEmptyView
        }
        set {
...
class LLEmptyView: EmptyDataSetSource, EmptyDataSetDelegate {
