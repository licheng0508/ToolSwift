...
let timeoutClosure = {(endpoint: Endpoint<ApiTool>, closure: MoyaProvider<ApiTool>.RequestResultClosure) -> Void in
...
extension ApiTool: TargetType {
    ...
    var baseURL: URL { return URL(string: BASE_URL + "v3/appV3_3/ios/phone")! }
